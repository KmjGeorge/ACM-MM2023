...
from model.module.vocalist.position_embedding import SinusoidalPositionalEmbedding
from model.module.vocalist.multihead_attention import MultiheadAttention
import math
